...
<Footer footerType="logo" class="bg-gray-800 text-white py-6">
	<div class="sm:flex sm:items-center sm:justify-between px-4 lg:px-8">
		<!-- Logo EduPlaner -->
		<FooterBrand href="/" class="flex items-center space-x-2">
			<img src="/logo-pjatk.png" alt="EduPlaner Logo" class="w-20 h-20" />
			<!-- Adjust the width and height as needed -->
			<span class="text-xl">EduPlaner</span>
	...
	<!-- Prawa autorskie -->
	<FooterCopyright href="/" by="EduPlaner™" class="text-sm text-gray-400 text-center" />
</Footer>
