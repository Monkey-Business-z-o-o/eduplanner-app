<nav class="bg-red-700 border-gray-200 text-white">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
            <a href="/" class="flex items-center space-x-2 bg-white hover:bg-red-200 transition-all duration-300 rounded-lg px-4 py-4">
                <img src="/logo-pjatk.png" alt="EduPlaner Logo" class="w-20 h-20" /> <!-- Adjust the width and height as needed -->
            ...
            EduPlaner
        </span> <!-- Adjust the font size as needed -->
            </a>

        <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            <a href="/login" class="flex items-center space-x-2 text-white hover:bg-white hover:text-black hover:scale-105 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-pink-500 transition-all duration-300">
                <i class="fas fa-key"></i>
                <span>Log in</span>
            </a>
            <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Register</a>
        ...
        <div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
            <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                <li>
                    <a href="#" class="block py-2 px-3 text-white hover:bg-white hover:text-black hover:scale-105 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm md:px-5 md:py-2.5 md:border-0 dark:text-blue-500 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700 transition-all duration-300" aria-current="page">Schedule</a>
                </li>
                <li>
