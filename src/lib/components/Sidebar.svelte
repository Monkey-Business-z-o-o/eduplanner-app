...
<div class="flex min-h-screen">
	<!-- Kontener Sidebar -->
	<div class="flex flex-col items-center w-20 h-full space-y-6 overflow-hidden bg-red-700 text-white lg:w-48 lg:items-start lg:space-y-4 lg:p-4 transition-all duration-300">
		...
		<!-- Menu -->
		<nav class="flex flex-col items-center w-full mt-4 lg:items-start">
			{#each menuItems as item}
				<a href="{item.link}" class="flex flex-col items-center w-full py-4 px-6 rounded-md hover:bg-white hover:text-black lg:flex-row lg:justify-start lg:px-4 transition-all duration-300 hover:scale-110">
